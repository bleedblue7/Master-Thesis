...
# PATH_TO_WORD2VEC = os.path.expanduser("/home/arghya/Documents/Thesis/GoogleNews-vectors-negative300.bin")
# PATH_TO_GLOVE = os.path.expanduser("/home/arghya/Documents/Thesis/glove.840B.300d.txt")
# tmp_file = get_tmpfile("/home/arghya/Documents/Thesis/temp_word2vec.txt")
# glove2word2vec('/home/arghya/Documents/Thesis/glove.840B.300d.txt', tmp_file)
# model = KeyedVectors.load_word2vec_format(tmp_file)
# model.save_word2vec_format('keyed-840B-300.bin.gz', binary=True)
# word2vec = gensim.models.KeyedVectors.load_word2vec_format(PATH_TO_WORD2VEC, binary=True)

word_vectors = KeyedVectors.load_word2vec_format('/home/arghya/Documents/Thesis/GoogleNews-vectors-negative300.bin', binary=True)
...
# pd_results.to_csv("/home/arghya/Documents/Thesis/NewResults/STS_WMD.csv")
...
plt.savefig("/home/arghya/Documents/Thesis/Plots/STS_WMD.pdf")