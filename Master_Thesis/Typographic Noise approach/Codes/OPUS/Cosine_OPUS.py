...
for error_rate in [0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4]:
    for _, row in data.iterrows():
        ...
        results.append({"sentence1": sent1, "sentence2": sent2, "method": "Cosine",
                        "ground_truth": ground_truth, "score": FLAIR_similarity, "noise_rate": error_rate, "absolute_error": error})
...
# pd_results.to_csv("/home/arghya/Documents/Thesis/NewResults/Cosine_OPUS.csv")
...
plt.savefig("/home/arghya/Documents/Thesis/Plots/Cosine_OPUS_new.pdf")
