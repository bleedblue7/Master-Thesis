...
for error_rate in [0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4]:
    for _, row in data.iterrows():
        ...
        results.append({"sentence1": sent1, "sentence2": sent2, "method": "Levenshtein",
                        "ground_truth": ground_truth, "score": levenshtein_Similarity, "noise_rate": error_rate,
...
# pd_results.to_csv("/home/arghya/Documents/Thesis/NewResults/Levenshtein_OPUS.csv")
...
plt.savefig("/home/arghya/Documents/Thesis/Plots/Levenshtein_OPUS.pdf")